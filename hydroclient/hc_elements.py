...
class ServicesModal:
    def __init__(self):
        ...
        self.input_search = SiteElement(
            By.CSS_SELECTOR,
            'div[id="tblDataServices_filter"] label input'
        )
...
class FilterModal:
    def __init__(self):
        ...
        self.find_in_table = SiteElement(
            By.CSS_SELECTOR,
            'input[aria-controls="tblDetailedSearchResults"]'
        )
...
class AboutModal:
    def __init__(self):
        ...
        self.license_repo_top = SiteElement(
            By.CSS_SELECTOR,
            '#licenseModal a[href="http://www.github.com/cuahsi"]'
        )
        ...
        self.contact_close = SiteElement(
            By.CSS_SELECTOR,
...
class ZendeskWidget:
    def __init__(self):
        ...
        self.search = SiteElement(
            By.CSS_SELECTOR,
            'input.src-component-field-SearchInput-searchInput'
        )
...
class ResourceCreatorPage:
    def __init__(self):
        self.create_time_resource = SiteElement(
            By.ID,
            'btn-create-timeseries-resource'
        )
