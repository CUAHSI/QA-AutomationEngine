...
public class SlimDigraphJoint extends digraph implements ViewableComponent
{
    /**
     ...
     */
   // protected SlimDigraphJoint myParent;

    /**
     * A graphical view of this digraph.
     */
    protected SlimDigraphView view;
     ...
     */
    public SlimDigraphJoint(String name)
    {
        super(name);
    }
    ...
    {
        // create the view
        view = new SlimDigraphView(this, modelView);
     ...
     * See member variable accessed.
     */
    public SlimDigraphView getDigraphView() {return view;}
    ...
    /*
    //by saurabh
    public void setMyParent(SlimDigraphJoint dg){
    //myParent = new SlimDigraphJoint("none");
     myParent =dg;
    }
*/
    public SlimDigraphJoint getMyParent(){return (SlimDigraphJoint) super.getParent();}
    ...
    public void add(ViewableAtomic iod){
      ...
      public void add(SlimDigraphJoint iod){
        //setMyParent(this);
        super.add((IODevs)iod);
      }
