...
public class SlimDigraphView extends JPanel implements ComponentView
{
    /**
     ...
     *                          view.
     */
    public SlimDigraphView(ViewableDigraph digraph_, SimView.ModelView modelView_)
    {
        digraph = digraph_;
    ...
    public void add(Component comp, Object constraints)
    {
        ...
        if (comp instanceof AtomicView || comp instanceof SlimDigraphView) {
