...
public class JenkinsSystem extends ViewableDigraph {
    private ViewableDigraph jenkins;
    private ViewableAtomic email;
    
    public JenkinsSystem(){
	super("JenkinsSystem");
	jenkins = new JenkinsView();
	email = new JenkinsEmailPlugin();
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("JenkinsView")).setPreferredLocation(new Point(196, 212));
        ((ViewableComponent)withName("JenkinsEmailPlugin")).setPreferredLocation(new Point(673, 659));
    }
}
