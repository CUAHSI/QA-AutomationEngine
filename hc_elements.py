...
class SearchPage:
    def __init__(self):
        ...
        self.service_filter = SiteElement('button', el_id='btnSelectDataServices',
        ...
        self.about_helpcenter = SiteElement('li', el_id='liZendeskTab',
                                            el_recursive=[SiteElement('span'), SiteElement('a')])
        self.about_license = SiteElement('li', el_id='liLicenseTab',
                                         el_recursive=[SiteElement('span'), SiteElement('a')])
        self.about_license_close = SiteElement('div', el_id='licenseModal',
                                               el_recursive=[SiteElement('button',
                                                                         el_class='close')])
        self.about_license_repo_top = \
            SiteElement('div', el_id='licenseModal',
                        el_recursive=[SiteElement('a', el_href='http://www.github.com/cuahsi')])
        self.about_license_repo_inline = \
            SiteElement('div', el_id='licenseModal',
                        el_recursive=[SiteElement('a', el_content='http://www.github.com/cuahsi')])
        self.about_contact = SiteElement('li', el_id='liContactTab',
                                         el_recursive=[SiteElement('span'), SiteElement('a')])
        self.about_contact_close = SiteElement('div', el_id='contactModal',
                                               el_recursive=[SiteElement('button',
                                                                         el_class='close')])
    ...
    def full_list_checkbox(self, item_name):
        return SiteElement('div', el_id='keywordTree',
                           el_recursive=[SiteElement('ul'),
                                         ...
                                         SiteElement(el_dom='./..'),
                                         SiteElement('span', el_class='fancytree-checkbox')])
    ...
    def full_list_expand(self, item_name):
        return SiteElement('div', el_id='keywordTree',
                           el_recursive=[SiteElement('ul'),
                                         SiteElement('span', el_content=item_name),
                                         SiteElement(el_dom='./..'),
                                         SiteElement('span', el_class='fancytree-expander')])


class AdvancedSearchPage:
    def __init__(self):
        self.value_type_tab = SiteElement('a', el_href='#valueTypePane')
        self.value_type_term_sort = SiteElement('table', el_id='tblCvValueType',
                                                el_recursive=[SiteElement('thead'),
                                                              SiteElement('tr'),
                                                              SiteElement('th',
                                                                          el_content='Term')])
        self.value_type_first = SiteElement('table', el_id='tblCvValueType',
...
class ServiceSearchPage:
    def __init__(self):
        ...
        self.nasa_noah = SiteElement('a', el_content='NLDAS Hourly NOAH Data',
                                     el_recursive=[SiteElement(el_dom='./../..'),
                                                   SiteElement(el_dom='./td[1]')])
        self.nasa_forcing = SiteElement('a', el_content='NLDAS Hourly Primary Forcing Data',
                                        el_recursive=[SiteElement(el_dom='./../..'),
                                                      SiteElement(el_dom='./td[1]')])
...
class FilterResultsPage:
    def __init__(self):
        ...
        self.select_any = SiteElement('table', el_id='tblDetailedSearchResults',
        ...
        self.sort_service = \
            SiteElement('div', el_id='tblDetailedSearchResults_wrapper',
                        el_recursive=[SiteElement('th', el_content='Service Title')])
    ...
    def __init__(self):
        ...
        self.sort_data_type = \
            SiteElement('div', el_id='tblMapMarker_wrapper',
                        el_recursive=[SiteElement('div', el_class='dataTables_scroll'),
                                      SiteElement('div', el_class='dataTables_scrollHead'),
                                      SiteElement('div', el_class='dataTables_scrollHeadInner'),
                                      SiteElement('table'),
                                      SiteElement('thead'),
                                      SiteElement('tr'),
                                      SiteElement('th', el_content='Data Type')])
        self.select_any = SiteElement('table', el_id='tblMapMarker',
                                      el_recursive=[SiteElement(el_dom='./tbody'),
                                                    SiteElement(el_dom='./tr'),
                                                    SiteElement(el_dom='./td'),
                                                    SiteElement(el_dom='./div')])
